...
def step_1(can_par):
    """
    Teststep 1: Send first frame of a multi frame request DIDs
    """
    stepno = 1
...
def step_2(can_par):
    """
    Teststep 2: send CF with with CF delay < 1000 ms
    """
    stepno = 2
...
def step_3(can_par, wait_start, can_answer):
    """
    Teststep 3: test if all requested DIDs are included in reply
    """
    stepno = 3
...
def step_4(can_par):
    """
    Teststep 4: Send first frame of a multi frame request DIDs
    """
    stepno = 4
    purpose = "Send first frame of a multi frame request DIDs"
    result = True
...
def step_6(can_par, wait_start, can_answer):
    """
    Teststep 6: test if none of the requested DIDs are included in reply
    """
    stepno = 6
    etp: CanTestExtra = SIO.extract_parameter_yml(
        "step_{}".format(stepno),
...
def run():
    ...
    # result: whole message received
        wait_start, can_answer, result_step_1 = step_1(can_par)
    ...
    # action: send request with FC_delay > timeout
    # result: whole message received
        result = result and step_3(can_par, wait_start, can_answer)

    # step4:
    # action:
    # result: whole message received
        wait_start, can_answer, result_step_4 = step_4(can_par)
        result = result and result_step_4
    ...
    # action:
    # result: whole message received
        result = result and step_6(can_par, wait_start, can_answer)
