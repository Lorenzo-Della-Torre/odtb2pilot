...
def precondition(network_stub, can_send, can_receive, can_namespace, result):
    """
    ...
    print()
    result = step_0(network_stub, can_send, can_receive, can_namespace, result)

    print("precondition testok:", result, "\n")
    return result


def step_0(network_stub, can_send, can_receive, can_namespace, result):
    """
    ...
    result = result and SUTE.teststep(network_stub, can_m_send, can_mr_extra, can_send,
                                      can_receive, can_namespace, stepno, purpose, timeout,
                                      min_no_messages, max_no_messages)
    print(SUTE.PP_CombinedDID_EDA0(SC.can_messages[can_receive][0][2], title=''))
    return result


def step_1(network_stub, can_send, can_receive, can_namespace, result):
    """
...
def step_3(network_stub, can_send, can_receive, can_namespace, result):
    """
    Teststep 3: Request report Generic Snapshot By DTC Number
    """
...
def step_4(network_stub, can_send, can_receive, can_namespace, result):
    """
...
def step_5(network_stub, can_send, can_receive, can_namespace, result):
    """
