...
def step_3(stub, s, r, ns):
    ...
    stepno = 3
    purpose = "verify RoutineControl result reply positively in Extended Session and routine is still running "
    timeout = 1 #wait a second for reply to be send
    min_no_messages = -1
    max_no_messages = -1
...
def step_4(stub, s, r, ns):
    ...
    stepno = 4
    purpose = "verify RoutineControl stop reply positively in Extended Session and routine is Completed"
    timeout = 1 #wait a second for reply to be send
    min_no_messages = -1
    max_no_messages = -1
...
def step_5(stub, s, r, ns):
    ...
    stepno = 5
    purpose = "verify RoutineControl result reply positively in Extended Session and routine is completed "
    timeout = 1 #wait a second for reply to be send
    min_no_messages = -1
    max_no_messages = -1
