...
def step_4(stub, can_send, can_receive, can_namespace, result):
    ...
    can_m_send = SC.can_m_send( "RoutineControlRequestSID",b'\xDC\x10', b'\x03')
    can_mr_extra = ''
...
def step_5(stub, can_send, can_receive, can_namespace, result):
    ...
    can_m_send = SC.can_m_send( "RoutineControlRequestSID",b'\xDC\x11', b'\x01')
    can_mr_extra = ''
...
def step_6(stub, can_send, can_receive, can_namespace, result):
    ...
    can_m_send = SC.can_m_send( "RoutineControlRequestSID",b'\xDC\x11', b'\x03')
    can_mr_extra = ''
...
def step_7(stub, can_send, can_receive, can_namespace, result):
    ...
    can_m_send = SC.can_m_send( "RoutineControlRequestSID",b'\xDC\x11', b'\x02')
    can_mr_extra = ''
