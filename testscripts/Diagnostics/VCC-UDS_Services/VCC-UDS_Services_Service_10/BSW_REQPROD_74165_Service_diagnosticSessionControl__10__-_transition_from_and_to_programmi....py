...
def step_4(stub, s, r, ns):
    ...
    time.sleep(1)
    print ()
    print ("Step4: messages received ", len(SC.can_messages[can_rec]))
    print ("Step4: messages: ", SC.can_messages[can_rec], "\n")
    print ("Step4: frames received ", len(SC.can_frames[can_rec]))
    print ("Step4: frames: ", SC.can_frames[can_rec], "\n")

    testresult = testresult and (len(SC.can_frames[can_rec]) == 0)
...
def step_6(stub, s, r, ns):
    ...
    time.sleep(1)
    print ()
    print ("Step6: messages received ", len(SC.can_messages[can_rec]))
