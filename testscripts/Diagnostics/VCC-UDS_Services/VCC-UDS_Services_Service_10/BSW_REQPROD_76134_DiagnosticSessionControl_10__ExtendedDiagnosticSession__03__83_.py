...
# teststep 3: Change to Extended session
def step_3(stub, s, r, ns):
    global testresult
    
    stepno = 3
    purpose = "Change to Extended session (83) from default"
    timeout = 1
    min_no_messages = -1
    max_no_messages = -1

    can_m_send = SC.can_m_send( "DiagnosticSessionControl", b'\x83', "")
    can_mr_extra = ''
    
    testresult = testresult and SuTe.teststep(stub, can_m_send, can_mr_extra, s, r, ns, stepno, purpose, timeout, min_no_messages, max_no_messages)
    testresult = testresult and not SC.can_messages[r]

# teststep 4: Extended session
...
def step_5(stub, s, r, ns):
    ...
    stepno = 5
    purpose = "Change to Extended session from Extended session"
    timeout = 1
    min_no_messages = 1
    max_no_messages = 1
...
def step_6(stub, s, r, ns):
    ...
    stepno = 6
    purpose = "Change to Extended session (83) from Extended"
    timeout = 1
    min_no_messages = -1
    max_no_messages = -1
...
# teststep 8: Change to Programming session
...
def step_9(stub, s, r, ns):
    ...
    stepno = 9
    purpose = "Change to Extended session(03) from Programming"
    timeout = 1
    min_no_messages = -1
    max_no_messages = -1
    ...
    testresult = testresult and SuTe.test_message(SC.can_messages[r], teststring='7F1012')

    print(SuTe.PP_Decode_7F_response(SC.can_frames[r][0][2]))

# teststep 10: Programming session
...
# teststep 11: Change to Extended session
def step_11(stub, s, r, ns):
    global testresult
    
    stepno = 11
    purpose = "Change to Extended session(83) from Programming"
    timeout = 1
    min_no_messages = -1
    max_no_messages = -1
...
def run():
    ...
    ############################################
    # step 1:
    # action: change BECM to Extended from default
    # result: BECM report mode
    step_1(network_stub, can_send, can_receive, can_namespace)

    # step 2:
    # action: change BECM to default(01)
    # result: BECM report mode
    step_2(network_stub, can_send, can_receive, can_namespace)

    # step 3:
    # action: change BECM to Extended(83) from default
    # result: No reply
    ...
    # step 5:
    # action: change BECM to Extended from extended
    # result: BECM report mode
    step_5(network_stub, can_send, can_receive, can_namespace)

    # step 6:
    # action: change BECM to Extended(83) from extended
    # result: No reply
    ...
    # step 9:
    # action: change BECM to Extended from programming
    # result: BECM report NRC
    ...
    # step 11:
    # action: change BECM to Extended(83) from programming
    # result: BECM report NRC
    step_11(network_stub, can_send, can_receive, can_namespace)

    #change BECM to default(01)
    # result: BECM report mode
