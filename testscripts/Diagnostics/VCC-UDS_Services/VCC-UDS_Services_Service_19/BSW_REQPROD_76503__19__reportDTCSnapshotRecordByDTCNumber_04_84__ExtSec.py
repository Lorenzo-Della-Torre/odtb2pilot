...
# teststep 2: verify that SnapshotRecordByDTCNumber are sent
def step_2(stub, s, r, ns):
    global testresult
    
    stepno = 2
    purpose = "verify that SnapshotRecordByDTCNumber are sent"
    timeout = 1 #wait a second for reply to be send
    min_no_messages = -1
    max_no_messages = -1

    can_m_send = SC.can_m_send( "ReadDTCInfoSnapshotRecordByDTCNumber", b'\x05\x8D\x00' ,b'\xFF')
    can_mr_extra = ''
...
def step_3(stub, s, r, ns):
    ...
    can_m_send = SC.can_m_send( "ReadDTCInfoSnapshotRecordByDTCNumber(84)", b'\x05\x8D\x00' ,b'\xFF')
    can_mr_extra = ''
...
def run():
    ...
    # step2:
    # action: send signal SnapshotRecordByDTCNumber
    # result: BECM respond positively
    step_2(network_stub, can_send, can_receive, can_namespace)

    # step3:
    # action: send signal SnapshotRecordByDTCNumber (84)
