...
# teststep 4: verify that SnapshotRecordByDTCNumber are sent for specific number
...
def run():
    ...
    # step3:
    # action: send signal SnapshotRecordByDTCNumber with specific Snapshot Number
    # result: BECM respond positively
    step_3(network_stub, can_send, can_receive, can_namespace)

    # step4:
    # action: send signal SnapshotRecordByDTCNumber with specific Snapshot Number (84)
