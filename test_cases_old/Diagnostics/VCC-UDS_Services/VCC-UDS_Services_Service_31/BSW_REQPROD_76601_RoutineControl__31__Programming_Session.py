...
# teststep 2: verify RoutineControlRequest is sent for Type 2
def step_2(can_p):
    """
    Teststep 2: verify RoutineControlRequest is sent for Type 2
    """
    ...
    result = result and SUTE.test_message(SC.can_messages[can_p["receive"]], teststring='7F3133')
    logging.info("Step%s, 7F_response: %s\n", etp["step_no"], SUTE.pp_decode_7f_response(SC.can_frames[can_p["receive"]][0][2]))
    return result
