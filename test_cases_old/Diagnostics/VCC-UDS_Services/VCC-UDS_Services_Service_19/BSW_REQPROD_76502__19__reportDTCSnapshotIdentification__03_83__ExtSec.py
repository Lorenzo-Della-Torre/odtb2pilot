...
# teststep 2: verify that Read DTC Snapshot Identification are sent
def step_2(stub, s, r, ns):
    global testresult
    
    stepno = 2
    purpose = "verify that Read DTC Snapshot Identification are sent"
...
# teststep 3: verify that Read DTC Snapshot Identification reply with empty frame
def step_3(stub, s, r, ns):
    global testresult
    
    stepno = 3
    purpose = "verify that Read DTC Snapshot Identification reply with empty frame"
    timeout = 1 #wait a second for reply to be send
    min_no_messages = -1
    max_no_messages = -1

    can_m_send = SC.can_m_send( "ReadDTCInfoSnapshotIdentification(83)", b'' , b'')
    can_mr_extra = ''
...
def run():
    ...
    # step2:
    # action: send signal ReadDTCSnapshotIdentification
    # result: BECM respond positively
    step_2(network_stub, can_send, can_receive, can_namespace)

    # step3:
    # action: send signal ReadDTCSnapshotIdentification (83)
