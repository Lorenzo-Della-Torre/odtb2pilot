...
SubscriberConfig = _reflection.GeneratedProtocolMessageType('SubscriberConfig', (_message.Message,), dict(
...
SignalIds = _reflection.GeneratedProtocolMessageType('SignalIds', (_message.Message,), dict(
...
PublisherConfig = _reflection.GeneratedProtocolMessageType('PublisherConfig', (_message.Message,), dict(
