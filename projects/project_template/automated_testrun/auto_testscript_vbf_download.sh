...
### Generate catalog for logfiles and list of scripts to run
	...
	# SWRS Testing
	python3 $TESTREPO/autotest/testcase_picker.py --txtfile $TESTREPO/test_folder/automated_ecm/vbf_download.txt --scriptfolder $TESTREPO/test_folder/automated_ecm > testscripts_auto.lst
