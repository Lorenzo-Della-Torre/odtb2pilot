...
#------------------------------Support Support SWDL Functions-------------------------------
    ...
    def activate_sbl(cls, can_p: CanParam, call, stepno,\
        ...
        logging.info("support_SBL, activate_sbl: received frames %s", SC.can_frames[can_p["receive"]])
        logging.info("support_SBL, activate_sbl: received messages %s", SC.can_messages[can_p["receive"]])
        testresult = testresult and (
            SUTE.pp_decode_routine_control_response(SC.can_messages[can_p["receive"]][0][2],
                                                    'Type1,Completed'))
        return testresult
