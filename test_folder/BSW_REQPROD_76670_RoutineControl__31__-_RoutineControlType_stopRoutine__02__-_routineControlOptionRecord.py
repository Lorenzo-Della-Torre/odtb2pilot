...
def step_2(can_p):
    ...
    etp: CanTestExtra = {
        "step_no": 2,
        "purpose": "verify RoutineControl start reply positively for routine with RC option",
        "timeout": 1,
        "min_no_messages": -1,
        "max_no_messages": -1
        }
...
def step_3(can_p):
    ...
    etp: CanTestExtra = {
        "step_no": 3,
        "purpose": "verify RoutineControl stop react positively for Routine with RC option",
        "timeout": 1,
        "min_no_messages": -1,
        "max_no_messages": -1
        }
