...
def run():
    ...
    if result:
        ...
        result, app_diag_part_num_response = result and step_2(can_p)

        # step 3:
        # action: Check the app_diag_part_num in SDDB and Application
        # result: ECU responds with DID F120
        SUTE.print_test_purpose(
            3, "Compare APP Diagnostic Part Numbers from Data Base and APP")
        ...
        # step 4:
        # action: Test all DID:s in dictionary whitin intrval
        #         [D900, DCFF] or [E300, E4FF] or [EE00, EFFF]
