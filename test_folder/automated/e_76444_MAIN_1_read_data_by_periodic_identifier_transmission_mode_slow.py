...
details: >
    ...
    less than 200ms.
    2. Verify transmission mode slow parameter in ReadDataByPeriodicIdentifier(0x2A) service.
"""
...
def request_read_data_periodic_identifier(dut: Dut, periodic_did):
    """
    Request ReadDataByPeriodicIdentifier(0x2A) with transmission mode slow parameter and
    ...
    """
    # Request periodic did with transmission mode slow parameter 0x01
...
def step_1(dut: Dut):
    ...
    action: Set to extended mode and verify ReadDataByPeriodicIdentifier(0x2A) response
            with transmission mode slow parameter.
...
def step_3(dut: Dut, periodic_did):
    ...
    action: Set to programming session and verify ReadDataByPeriodicIdentifier(0x2A) negative
            response with transmission mode slow parameter.
...
def run():
    """
    Verify transmission mode slow parameter in ReadDataByPeriodicIdentifier(0x2A) service
    """
    dut = Dut()
