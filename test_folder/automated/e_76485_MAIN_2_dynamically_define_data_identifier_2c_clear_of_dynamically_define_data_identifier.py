...
details: >
    Verify response for dynamicallyDefineDataIdentifier(0x2C) - clear of
    dynamicallyDefineDataIdentifier in default & extended session with response code 0x6C
    and it should not support in programming session.
"""
...
def run():
    """
    Verify Service dynamicallyDefineDataIdentifier(0x2C)-clear of dynamicallyDefineDataIdentifier
    is supporting in all sessions
