...
title:
    ...
    Support for DTC time stamp #21 ; 5
...
description:
    ...
    DTCExtendedDataRecordNumber=21 shall be implemented according to the
    following definition:

    - The record value shall be equal to the global real time (data record
      0xDD00) that is taken the latest time FDC10 reaches UnconfirmedDTCLimit,
      since DTC information was last cleared

    - The time stamp shall only be taken the first time if the FDC10 reaches
      UnconfirmedDTCLimit more than once during an operation cycle.
