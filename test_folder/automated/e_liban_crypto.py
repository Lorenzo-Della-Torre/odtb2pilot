...
def security_access_corrupt(dut: Dut):
    """
    Security access to ECU and get subfunctions response
    Args:
        dut(Dut): An instance of Dut
    ...
    logging.info("6666666666666666666666666666666 %s",response)
    ...
    logging.info("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa %s",response)
...
def step_1(dut: Dut):
    ...
    """
    dut.uds.set_mode(3)
    sa_response_dict = security_access_corrupt(dut)
