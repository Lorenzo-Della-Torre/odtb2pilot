...
def step_2(can_p: CanParam):
    ...
    cpay: CanPayload = {
        "payload": SC_CARCOM.can_m_send("ReadDataByIdentifier", b'\xD0\x34',
                                        b''),
        "extra": b''
    }
    ...
    logging.info("Step %s: Result within %s seconds.", stepno,
...
def step_3(can_p: CanParam):
    ...
    wait_start = time.time()
    cpay: CanPayload = {
        "payload": SC_CARCOM.can_m_send("ReadDataByIdentifier", b'\xDA\xC3',
                                        b''),
        "extra": b''
    }
    etp: CanTestExtra = {"step_no": stepno,\
...
def step_4(can_p: CanParam):
    ...
    wait_start = time.time()
    cpay: CanPayload = {
        "payload": SC_CARCOM.can_m_send("ReadDataByIdentifier", b'\xDA\xC6',
                                        b''),
        "extra": b''
    }
    etp: CanTestExtra = {"step_no": stepno,\
...
def step_5(can_p: CanParam):
    ...
    wait_start = time.time()
    cpay: CanPayload = {
        "payload": SC_CARCOM.can_m_send("ReadDataByIdentifier", b'\xFD\x71',
                                        b''),
        "extra": b''
    }
    etp: CanTestExtra = {"step_no": stepno,\
...
def step_6(can_p: CanParam):
    ...
    wait_start = time.time()
    cpay: CanPayload = {
        "payload": SC_CARCOM.can_m_send("ReadDataByIdentifier", b'\xFD\x72',
                                        b''),
        "extra": b''
    }
    etp: CanTestExtra = {"step_no": stepno,\
...
def run():
    ...
    can_p: CanParam = {
        ...
        "netstub" : SC.connect_to_signalbroker(ODTB2_DUT, ODTB2_PORT),\
    ...
    logging.info("Time needed for testrun (seconds): {:.3f}".format(
