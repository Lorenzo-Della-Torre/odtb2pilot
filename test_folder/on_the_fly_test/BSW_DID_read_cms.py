...
def step_2(can_p):
    """
        teststep 2: request DID CMS FD40 (MEP2 HVBM: CMS Error)
    """
    ...
    etp: CanTestExtra = {"step_no": stepno,\
                         "purpose" : "request HVBM DID CMS Error",\
                         "timeout" : 1,\
                         "min_no_messages" : 1,\
                         "max_no_messages" : 1
                        }
...
def step_3(can_p):
    """
        teststep 3: request DID CMS FD41 (MEP2 HVBM CMS Calibration result)
    """
    ...
    SIO.extract_parameter_yml(str(inspect.stack()[0][3]), cpay)
    etp: CanTestExtra = {"step_no": stepno,\
                         "purpose" : "request HVBM DID CMS calibration results",\
                         "timeout" : 1,\
                         "min_no_messages" : 1,\
                         "max_no_messages" : 1
                        }
...
def step_5(can_p):
    """
        teststep 5: request DID CMS FD61 CMS Communication Status
    """
    ...
    SIO.extract_parameter_yml(str(inspect.stack()[0][3]), cpay)
    etp: CanTestExtra = {"step_no": stepno,\
                         "purpose" : "request HVBM DID FD61 CMS Communication Status",\
                         "timeout" : 1,\
                         "min_no_messages" : 1,\
                         "max_no_messages" : 1
                        }
...
def step_6(can_p):
    """
        teststep 6: request DID CMS FD62 CMS sense supply status
    """
...
def step_7(can_p):
    """
        teststep 7: request DID CMS DB8A CMS Device
    """
    ...
    SIO.extract_parameter_yml(str(inspect.stack()[0][3]), cpay)
    etp: CanTestExtra = {"step_no": stepno,\
                         "purpose" : "request HVBM DID CMS Device ID",\
                         "timeout" : 1,\
                         "min_no_messages" : 1,\
                         "max_no_messages" : 1
                        }
...
def step_8(can_p):
    """
        teststep 8: request DID CMS DB8B CMS Device ID NVRAM
    """
    ...
    SIO.extract_parameter_yml(str(inspect.stack()[0][3]), cpay)
    etp: CanTestExtra = {"step_no": stepno,\
                         "purpose" : "request HVBM DID CMS Device ID NVRAM",\
                         "timeout" : 1,\
                         "min_no_messages" : 1,\
                         "max_no_messages" : 1
                        }
...
def step_9(can_p):
    """
        teststep 9: request BECM DID 4802 HV Battery Current
    """
    ...
    SIO.extract_parameter_yml(str(inspect.stack()[0][3]), cpay)
    etp: CanTestExtra = {"step_no": stepno,\
                         "purpose" : "request BECM DID 4802 HV Battery current",\
                         "timeout" : 1,\
                         "min_no_messages" : 1,\
                         "max_no_messages" : 1
                        }
...
def step_10(can_p):
    """
        teststep 10: request BECM DID 4A55 HV Battery Current
    """
    ...
    SIO.extract_parameter_yml(str(inspect.stack()[0][3]), cpay)
    etp: CanTestExtra = {"step_no": stepno,\
                         "purpose" : "request BECM DID 4A55 HV Battery Current",\
                         "timeout" : 1,\
                         "min_no_messages" : 1,\
                         "max_no_messages" : 1
                        }
...
def run():
    ...
    for _ in range(2):
        ...
        result = step_9(can_p) and result
    ...
    logging.info("postcondition done. Waiting for script to end")
